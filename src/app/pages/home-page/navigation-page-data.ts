                ...
                children: [
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/lue4Em1AKfY',
                                    urduText:
                                        'بچے کچرے کو سڑک پر نہ پھینکنا سکھاتے ہیں',
                                    hindiText:
                                        'सड़क पर कचरा नहीं फेंकना सिखा रहे बच्चे',
                                    englishText:
                                        'Kids teaching not to throw garbage on road',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/LLWxZymPBYo',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/aLaLbNm3W34',
                                    urduText:
                                        'سڑک پر تھوکنے کی ایک مزاحیہ ویڈیو',
                                    hindiText:
                                        'सड़क पर थूकने का एक मज़ेदार वीडियो',
                                    englishText:
                                        'a funny video of spitting on road',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/iNRavFdKC8U',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/XT9aDTC1aFY',
                                    urduText:
                                        'ویڈیو دیکھنا جاری رکھیں اور کل نقصان گنیں',
                                    hindiText:
                                        'वीडियो को देखते रहें और कुल नुकसान को गिनें',
                                    englishText:
                                        'keep on watching the video and count the total loss',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/fsdGsUOKWu4',
                                    urduText:
                                        'سڑک پر کچرا جمع ہونا کس طرح شروع ہوتا ہے؟',
                                    hindiText:
                                        'सड़क पर कचरा कैसे जमा होना शुरू होता है?',
                                    englishText:
                                        'how garbage starts collects on road?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/2fs0IUQlzbw',
                                    urduText:
                                        'مسجد کی صفائی کرنے والے کچھ نوجوان - پونہ مہاراشٹر',
                                    hindiText:
                                        'मस्जिद की सफाई करते कुछ नौजवान - पूना महाराष्ट्र',
                                    englishText:
                                        'few young people cleaning Masjid - Pune Maharashtra',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Huj1s7fRBB4',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/CRtVOE3zolw',
                                    urduText: 'یورپ اور ہمارے معاشرے میں صفائی',
                                    hindiText:
                                        'यूरोप और हमारे समाज में स्वच्छता',
                                    englishText:
                                        'cleanliness in Europe and in our society',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/u3-uzMk90G8',
                                    urduText:
                                        'گھر اور کپڑا صاف لیکن معاشرے گندا',
                                    hindiText:
                                        'घर और कपड़ा साफ लेकिन समाज गंदा',
                                    englishText:
                                        'House and cloth clean but society dirty',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/E4xQmyKN_Z0',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/18vN6X912os',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/qu07R5HbNqE',
                                    urduText:
                                        'موٹاپا ہر طرح کی بیماری کا سبب ہے',
                                    hindiText: 'मोटापा सभी बीमारी की वजह है',
                                    englishText:
                                        'Obesity is reason for all deceases',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/GKni72rRKow',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/0kPfBb-jGAw',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/gQ-oKGKb9v0',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/lz71IL6ZUxg',
                                    urduText: 'دیندار لوگ بھی موٹے ہوتے ہیں',
                                    hindiText: 'दीनदारा लोग भी मोठे होते हैं',
                                    englishText:
                                        'religious people are also obese',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/I9woF0Ry5A8',
                                    urduText:
                                        'کب کھانا ہے اور کب کھانا بند کرنا ہے؟',
                                    hindiText:
                                        'कब खाना है और कब खाना बंद करना है?',
                                    englishText:
                                        'when to eat and when to stop eating?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/GOrxCTajtUs',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/vdmenPb41qw',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/mTYFnB1T2qU',
                                    urduText:
                                        'لوگ بوفے سسٹم میں بھی کھانا ضائع کرتے ہیں',
                                    hindiText:
                                        'लोग बुफे सिस्टम में भी खाना बर्बाद करते हैं',
                                    englishText:
                                        'People waste food even in buffet system',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/5II0d0B6p4s',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/Cns3xYkjux8',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/xwdlTrP-mno',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/8Qbl1UJWNQQ',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/TKRN3toGpsE',
                                    urduText:
                                        'روٹی بینک۔ اورنگ آباد مہاراشٹر انڈیا',
                                    hindiText:
                                        'रोटी बैंक - औरंगाबाद महाराष्ट्र भारत',
                                    englishText:
                                        'Roti Bank - Aurangabad Maharashtra India',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/AbgnjpdFiTs',
                                    urduText: 'وضو کرتے وقت پانی ضائع کرنا',
                                    hindiText: 'वुज़ू करते हुए पानी बर्बाद करना',
                                    englishText:
                                        'Wasting water while doing ablution',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/rnLZ79F38wE',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/8ZF3Wa07r5A',
                                    urduText:
                                        'مولاانا طارق جمیل فون کے ستاہے ہوا',
                                    hindiText:
                                        'मौलाना तारिक़ जमील फ़ोन के सताए हुवे',
                                    englishText:
                                        'Maulana Tariq Jameel annoyed with phone',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/dnIUs5nRx7o',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/3Z7Tlxsb0KI',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/TeN0nuFgJHk',
                                    urduText: 'مسجد میں موبائل فون کے آداب',
                                    hindiText: 'मस्जिद में मोबाइल फोन का आदाब',
                                    englishText:
                                        'Etiquette of mobile phone in masjid',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/9NB_ebkvjuo',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/hPE9WSUnpuo',
                                    urduText: 'सोशल मीडिया में 5 साल बर्बाद',
                                    hindiText:
                                        '5 سال سوشل میڈیا میں برباد ہوئے',
                                    englishText:
                                        '5 years wasted in social media',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/iRZq5XWdWSA',
                                    urduText:
                                        'جھوٹھے وہاتساپپ پیغامات نے انسان کی جان لے لی',
                                    hindiText:
                                        'फेक/झूठे मेस्सगेस ने इंसान की जान ले ली',
                                    englishText:
                                        'Fake messages took lives of human being',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/7ZgoaIAHVvQ',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/Ebn2vvqElDM',
                                    urduText:
                                        'مشت زنی کے مضر اثرات - ایک ڈاکٹر کے ذریعہ',
                                    hindiText:
                                        'मुश्त ज़नी (अपने हाथ से पेशाब की जगह से मनि निकालना )के साइड इफेक्ट्स - एक डॉक्टर द्वारा',
                                    englishText:
                                        'Side effects of Masturbation - By a doctor',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/mt4MeYFGCzo',
                                    urduText:
                                        'فحش - حقیقت - پیر ذوالفقار کے ذریعہ',
                                    hindiText:
                                        'पोर्न - वास्तविहकीकत कता - पीर जुल्फिकार',
                                    englishText:
                                        'Porn - the reality - By Peer Zulfiqar',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/8MTZ4btuURw',
                                    urduText:
                                        'کس طرح فحش فلمیں شادی کو تباہ کرتی ہے؟',
                                    hindiText:
                                        'शादी को कैसे बर्बाद करता है पोर्न?',
                                    englishText: 'How porn destroys marriage?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/DQBATuqKp9A',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/gvsPI2X_reA',
                                    urduText:
                                        'آپ جو بھی دیکھ رہے ہیں وہ سب نقلی ہے۔ سب سے بڑی پیسا دینے والی صنعت',
                                    hindiText:
                                        'आप सभी देखें नकली है। सबसे बड़ा पैसा उद्योग',
                                    englishText:
                                        'all you see is fake. biggest money industry',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/yeDAC422Cks',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/wVBPvrg7e9s',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/QgJeYifYL1A',
                                    urduText:
                                        'کس طرح فحش آپ کے دماغ کو ختم کرتی ہے',
                                    hindiText:
                                        'कैसे पोर्न आपके दिमाग को नष्ट कर देता है',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/-6UaCdGT1mI',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/xwyChsFjsBw',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/k2YvzlgoVp0',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/4CQFBRrWArE',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/hRA8qjion4g',
                                    urduText: 'پیشہ ور بھکاریوں کو پیسے دینا',
                                    hindiText:
                                        'पेशेवर भिखारियों को पैसे देते हैं',
                                    englishText:
                                        'Giving money to professional beggars',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/gRtsfX4k9VY',
                                    urduText:
                                        'سڑکوں پر کے مانگنے والوں کو پیسے کے علاوہ مدد کریں',
                                    hindiText:
                                        'सड़क पर के मांगने वालों को पैसे के अलावा मदद करें',
                                    englishText:
                                        'Help street begger not with money',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/I_-SP4kCNVo',
                                    urduText:
                                        'جھوٹھے سڈاکوں کے بھکارو کو رنگے ہاتھ پکڑا',
                                    hindiText:
                                        'नकली सड़क भिखारी को रंगे हाथ पकड़ा',
                                    englishText:
                                        'Fake street beggar caught red handed',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/MDgPMnacals',
                                    urduText:
                                        'ایک بھکاری جو آپ سے زیادہ امیر ہے',
                                    hindiText:
                                        'एक भिखारी जो आपसे ज्यादा अमीर है',
                                    englishText:
                                        'A beggar who is richer than you',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/qmjdQ236Dus',
                                    urduText: 'اس معاملے میں صدقہ کرنا حرام ہے',
                                    hindiText: 'इस मामले में सदक़ा करना हराम है',
                                    englishText:
                                        'Doing charity is Haram in this case?',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/QXwZLdQG3nw',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/psDT3YCV-Lo',
                                    urduText:
                                        'چین کو ایک بچے کی پالیسی ختم کیوں کرنی پڑی؟',
                                    hindiText:
                                        'चीन को एक बच्चे की पॉलिसी ख़तम क्यूं करनी पड़ी?',
                                    englishText:
                                        'Why china had a abolish one child policy?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/15wN2lwGYN4',
                                    urduText:
                                        'دنیا کا پیسہ اور وسائل صرف چند لوگوں کے ہاتھوں میں ہے',
                                    hindiText:
                                        'दुनिया का पैसा सिर्फ चंद लोगों के हाथों में है।',
                                    englishText:
                                        "World wealth/money is only few people's hand",
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Getvca8shZ8',
                                    urduText: 'کسی کا مال نہ حق کھانا',
                                    hindiText: 'किसी का माल ना हक़ खाना',
                                    englishText:
                                        "illegally taking someone's money",
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/phBN9b-kexU',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/nKD9O4eFIig',
                                    urduText:
                                        'حکومتی نوکریوں میں ہندوستان کے مسلمانوں کا تناسب کتنا ہے؟',
                                    hindiText:
                                        'कितने इंडियन मुस्लिम गवर्नमेंट नौकरी करते हैं?',
                                    englishText:
                                        'How many Indian Muslim in government jobs?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/a_u1FmXc32c',
                                    urduText:
                                        'ہندوستان کے مسلمانوں کی بدحالی کے پانچ وجوہات',
                                    hindiText:
                                        'हिन्दुस्तान के मुसलमानों की बद हाली की पांच वजह',
                                    englishText:
                                        'Five reasons of Muslim backwardness in India',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/iG6e0JUWuNE',
                                    urduText:
                                        'ہندوستان مسلمانوں کے تعلیمی معدوم شمارہ کے نمبر',
                                    hindiText:
                                        'हिन्दुस्तान में मुस्लिम एजुकेशन सर्वे',
                                    englishText:
                                        'Statistics data on indian muslim education',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/mt75TIa1ul0',
                                    urduText:
                                        'آج مسلمان سائنس میں کیوں نہیں ہیں؟',
                                    hindiText:
                                        'आज साइंस में मुसलमान क्यों नहीं हैं?',
                                    englishText:
                                        'why muslims are not in science today?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Tsqu2KBu6SU',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/qFOvxG5sXpM',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/o1xf78EltKM',
                                    urduText:
                                        'اکیلی ماں کی زندگی - بغیر باپ کے',
                                    hindiText:
                                        'अकेली माँ का जीवन (पिता के बिना)',
                                    englishText:
                                        'Life of a single Mom (without father).',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/hBR0_VIuf-A',
                                    urduText: 'شادی کے بغیر بچے',
                                    hindiText: 'शादी के बिना के बच्चे',
                                    englishText:
                                        'Out of wedlock (without marriage) kids',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/1y6A8BnKbCA',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/Q8G1IsoSDJk',
                                    urduText:
                                        'برطانیہ میں ہر سال 6000 مرد خودکشی کرتے ہیں',
                                    hindiText:
                                        'ब्रिटेन में हर साल 6000 पुरुष आत्महत्या करते हैं',
                                    englishText:
                                        '6000 Men commit suicide every year in UK',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/RLDNlME5pYo',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/X44sG4Bfp2Y',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/EnUqDjCqg0A',
                                    urduText: 'ہم جنسی میں ذہنی بیماریاں',
                                    hindiText:
                                        'समान सेक्स मैरिज में दिमागी प्रॉब्लम',
                                    englishText:
                                        'Mental problem in same sex marriage',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/S50HD8plkVI',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/FwHa5INAi4s',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/0hJddnvyeqE',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/NztfcknqHgk',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/0Lc_HjTpB0A',
                                    urduText: 'شہر قاضی کی ذمہ داری کیا ہے؟',
                                    hindiText:
                                        'शायर काजी की जिम्मेदारी क्या है?',
                                    englishText:
                                        'what is responsibility of shaher Qazi?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/WRfeReykaK0',
                                    urduText:
                                        'شہر ناندیڑ میں دارالقضا کی مجموعی رپورٹ',
                                    hindiText:
                                        'शहर नांदेड़ में दारुल क़ज़ा की रिपोर्ट',
                                    englishText:
                                        'overall Report of Darul Qaza in city Nanded',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/RT6dpxydc9g',
                                    urduText:
                                        'ہندوستانی عدلیہ کے نظام کو دارالقضا سے فائدہ',
                                    hindiText:
                                        'दारुल क़ज़ा से भारत के क़ानूनी सिस्टम को फ़ायदा',
                                    englishText:
                                        'Benefit of Darul Qaza to Indian judiciary system',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/GFIO-hHhk7o',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/qw2_Hn9GrCU',
                                    urduText:
                                        'دارالقضا کیا ہے - ایک وکیل کے ذریعہ',
                                    hindiText:
                                        'दारुल क़ज़ा क्या है - एक वकील के ज़रिये',
                                    englishText:
                                        'What is Darul Qaza - by an Advocate',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/wCO26NFxlzw',
                                    urduText:
                                        'ہندوستان عدالت میں پینڈنگ کورٹ کیس',
                                    hindiText:
                                        'इंडिया में कितने कोर्ट कैसे अभी भी पेंडिंग है',
                                    englishText:
                                        'Total pending court cases in India',
                                },
                            ],
                        },
                    },
                ...
                children: [
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/ahMtxBxgZCY',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/h79UTzBuSjQ',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/fmUN2g2DDCg',
                                    urduText:
                                        'مرنے کے پہلے پراپرٹی تقسیم کرنا کیسا ہے ؟',
                                    hindiText:
                                        'मरने के पहले प्रॉपर्टी तक़सीम करना',
                                    englishText:
                                        'division of property before death',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Pc_IZkFXk48',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/Hgp3gPmF5Yc',
                                    urduText:
                                        'والدین کی موت کے بعد بچوں میں جھگڑے',
                                    hindiText:
                                        'माँ बाप के मरने के बाद बच्चों में झगडे',
                                    englishText: 'Fight after death of parent.',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/zSb5YoqHQNA',
                                    urduText:
                                        'جائیداد کی تقسیم کے بارے میں کچھ معلومات',
                                    hindiText:
                                        'जायदाद की तक़सीम के बारे में कुछ मालूमात',
                                    englishText:
                                        'some knowledge about property distribution',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/UDZYGEBuiK4',
                                    urduText:
                                        'جائیداد کی تقسیم کے بارے میں کچھ معلومات',
                                    hindiText:
                                        'जायदाद की तक़सीम के बारे में कुछ मालूमात',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/kRDK47zQOgc',
                                    urduText:
                                        'قرآن مجید کی 4 آیات جس پر بہت سی کتابیں لکھی گئیں ہیں',
                                    hindiText:
                                        'कुरान की 4 आयतें जिन पर कई किताबें लिखी गई हैं',
                                    englishText:
                                        '4 verses of Quran on which many books have been written',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/sgXlcm--kMA',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/WfWtpjzdH-U',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/6sfFfhtzFgE',
                                    urduText:
                                        'ایسا مسلم مت بنو جو صرف نماز پڑھتا ہو',
                                    hindiText:
                                        'ऐसा मुस्लिम मत बनो जो सिर्फ नमाज़ पढ़ता हो।',
                                    englishText:
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/5gd_E5TT-LI',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/tNkBzxGvHgI',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/-kfpKDQqSmQ',
                                    urduText:
                                        'شہید کا قرض بھی معاف نہیں ہوتا ہے',
                                    hindiText:
                                        'एक शहीद का कर्ज भी माफ नहीं होता',
                                    englishText:
                                        'Debt of a martyr is also not forgiven',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/0UZCHh1yQ0U',
                                    urduText:
                                        'قرض واپس کرنے کے وقت لوگوں کا لہجہ بدل جاتا ہے۔',
                                    hindiText:
                                        'लोग कर्ज वापस करते समय टोन बदल देते हैं।',
                                    englishText:
                                        'people change tone at the time of returning the debt.',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/xOrgk5xxAXk',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/HSAs7yYdIgI',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/xgSqtlui0H0',
                                    urduText:
                                        'میں نے کسکا قرض واپس کیا تھا کہ اب کرونگا',
                                    hindiText:
                                        'किसका क़र्ज़ मैं ने वापस किया के अब करूंगा',
                                    englishText:
                                        'to whom i returned debt that i will return now',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Y_A1SG3Fijg',
                                    urduText:
                    ...
                    },
                    {
                        ...
                        content: {
                            heading:
                                'MUSLIM BUSINESSMEN AND WHY BUSINESS DOES NOT WORK',
                            text:
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/UaVv8swrkJc',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/_iosjWAhJwQ',
                                    urduText: 'سست تاجر',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/LwD2IA0GSWY',
                                    urduText: 'تجارت اور دین کی محنت',
                                    hindiText: 'तिजारत और दिन की मेहनत',
                                    englishText:
                                        'Business and doing effort for deen',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/5E-zoxqqnU0',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/bgz2uh5hLMU',
                                    urduText:
                                        'کاروبار میں غصّے والے کسٹمر سے کیسے برتاو کریں',
                                    hindiText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/FxVh-md3N_I',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/1QtxHKfHhAU',
                                    urduText:
                                        'تقدیر اور توکل پر غلط یقین اور بزنس',
                                    hindiText:
                                        'तकदीर और तवक्कल का गलत यकीन और बिज़नेस',
                                    englishText:
                                        'wrong belief/tawakkal on luck/destiny and business',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/bPsXZiiRHOQ',
                                    urduText:
                                        'آپ کو شروع میں 16-18 گھنٹے کام کی ضرورت ہے',
                                    hindiText:
                                        'आपको शुरुआत में 16-18 घंटे बिताकाम करने की जरूरत है',
                                    englishText:
                                        'you need to spend 16-18 hours in the beginning',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/pm5z4jO5xRQ',
                ...
                children: [
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/-HWIfBKtVBU',
                                    urduText:
                                        'کیا صرف علمائے کرام قرآن کو سمجھ سکتے ہیں؟',
                                    hindiText:
                                        'क्या सिर्फ उलेमा ही कुरान को समझ सकते हैं?',
                                    englishText:
                                        'Can only ulema understand Duran?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/GRBAdf_rDbM',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/kZUXl9JbdVw',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/G7M_GS9bbng',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/4a0JTlXJX4Y',
                                    urduText:
                                        'کیسے بطور کتاب قرآن مجید تخلیق ہوا',
                                    hindiText:
                                        'कुरान को एक किताब के रूप में कैसे बनाया गया',
                                    englishText: 'How Quran created as a book',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/B-ye0mnqF9k',
                                    urduText:
                                        'قرآن مجید کے مشہور مفسیر کی سیرت',
                                    hindiText:
                                        'कुरान की मशहूर मुफस्सिर की ज़िन्दगी',
                                    englishText:
                                        'biography of famous mufassir of Quran',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Tzfl9aVfZow',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/BycnUq1UO5o',
                                    urduText:
                                        'کیا کیمسٹری حیاتیات آپ کو اچھے انسان بنائے گی؟',
                                    hindiText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/NBkbJZ1jGdg',
                                    urduText:
                                        'کیسے بطور کتاب قرآن مجید تخلیق ہوا',
                                    hindiText:
                                        'कुरान को एक किताब के रूप में कैसे बनाया गया',
                    ...
                    },
                    {
                        ...
                        content: {
                            heading:
                                'LIFE OF PROPHET MOHAMMAD (PEACE BE UPON HIM)',
                            text:
                            ...
                            videosList: [
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/LZ-dByA1D6U',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/vupHu4ZRZ8I',
                                    urduText:
                                        'مکہ سے مدینہ (یثرب) حجرت کا واقعہ',
                                    hindiText:
                                        'मक्काह से मदीना (यसरीब)हिजरत का वाकया',
                                    englishText:
                                        'Hijrat from Makkah to Madina (yasrib)',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/s4-0chXu4LE',
                                    urduText:
                                        'مدینہ کے اور وہاں کے مقامی قبائل کی حالات',
                                    hindiText:
                                        'मदीना और वहां के कबीले के हालात',
                                    englishText:
                                        'Background of Madina and locals Tribes',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/8FFOZidDtDg',
                                    urduText: 'جنگ بدر',
                                    hindiText: 'जंग बदर',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/kyWgoFHoMvQ',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/wJXZEP6JBvs',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/EdvtnhBHF4s',
                                    urduText:
                                        'آخری لمحہ اور نبی محمد صلی اللہ علیہ وسلم کی وفات',
                                    hindiText:
                                        'अल्लाह के नबी के आखरी लम्हात और वफ़ात',
                                    englishText:
                                        'Last moment and Death of prophet Mohammad (pbuh)',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/eEVHdeZLgl0',
                                    urduText: 'دنیا کی 100 اثر دار شخصیات',
                                    hindiText: 'दुनिया की १०० असर दार शक्सियात',
                                    englishText:
                                        'Top 100 influential personalities of the world',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/o-KlFGWUvFY',
                                    urduText:
                                        'غیر مسلم سے برتاو کے بارے میں حدیث',
                                    hindiText:
                                        'गैर-मुसलमानों के बर्ताव के बारे में हदीस',
                                    englishText:
                                        'Hadis regarding treating non-muslims',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/rvejUe8_h3A',
                                    urduText: 'غیر مسلم سے برتاو کے بارے میں',
                                    hindiText:
                                        'गैर-मुसलमानों के बर्ताव के बारे में',
                                    englishText:
                                        'regarding treating non-muslims',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/htLhRe08bWw',
                                    urduText:
                                        'نبی محمد نے غیر مسلموں کے ساتھ کیسا سلوک کیا؟',
                                    hindiText:
                                        'पैगंबर मोहम्मद ने गैर मुसलमानों से कैसे व्यवहार किया?',
                                    englishText:
                                        'how prophet Mohammad treated non Muslims?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/CHFtfe_5L8c',
                                    urduText: 'غیر مسلم اقلیتوں کے قانونی پہلو',
                                    hindiText:
                                        'गैर-मुस्लिम अल्पसंख्यकों के कानूनी पहलू',
                                    englishText:
                                        'legal aspects of non-Muslim minorities',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/XB94Q2j94uo',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/XkCxohRT6rk',
                                    urduText:
                                        'پرساد کھانے کی اجازت کیوں نہیں ہے؟',
                                    hindiText:
                                        'प्रसाद खाने की अनुमति क्यों नहीं है?',
                                    englishText:
                                        'why eating prasad is not allowed?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/QbhP8EmGh3s',
                                    urduText:
                                        'اسلامی حکمرانی میں اقلیتیں (غیر مسلم) 13 پوائنٹس',
                                    hindiText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/d40Iq8LJ4G4',
                                    urduText:
                                        'خلیفہ عمر نے ایک غیر مسلم بھکاری کی مدد کی',
                                    hindiText:
                                        'खलीफा उमर ने एक गैर मुस्लिम भिखारी की मदद की',
                                    englishText:
                                        'Caliph Umar helped a non muslim begger',
                                },
                            ],
                        },
                    },
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/JYuNKqlLExo',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/lrBvB4OG_TA',
                                    urduText: 'اذان بے سری اور غلط کیوں',
                                    hindiText: 'अज़ान बेसुरी और गलता क्यों',
                                    englishText:
                                        'Why Azan is wrong and tunless',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/QPWVY_rYEzI',
                                    urduText:
                                        'غیر مسلم لڑکے نے اذان مقابلہ جیت لیا- سولاپور',
                                    hindiText:
                                        'गैर मुस्लिम लड़के ने जीता अज़ान कॉम्पेटेशन -शोलापुर',
                                    englishText:
                                        'Non-Muslim boy won Azan Competition -Solapur',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/EdbzK8iTjwE',
                                    urduText: 'غلط اذان سننے کی اجازت نہیں ہے',
                                    hindiText:
                                        'गलत अज़ान सुनने की इजाज़त नहीं है',
                                    englishText:
                                        'It is not allowed to listen incorrect Azan',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/PfMbjwDdFzA',
                                    urduText: 'شیخ زاید ابو ظبی اذان',
                                    hindiText:
                                        'शेख जायद मस्जिद -अबू धाबी अज़ान',
                                    englishText:
                                        'Shaikh Zayed Masjid -Abu Dhabi Azan',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/61oQvK6Rmgw',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/b868szgrsAw',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/g7_Mt6BoMo0',
                                    urduText:
                                        'تقدیر یا پلاننگ /تدبیر/منصوبہ بندی',
                                    hindiText:
                                        'तक़दीर और प्लानिंग/तदबीर/मंसूबा बंदी',
                                    englishText: 'Destiny or planning?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/fh9Es4uwG4g',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/sVsdBw0VG0U',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/Lh7mSKaTO9M',
                                    urduText:
                                        'اگر سب کچھ قسمت میں ہے تو مزید تعلیم کیوں حاصل کریں؟',
                                    hindiText:
                                        'अगर सब कुछ तक़दीर से है तो आगे क्यों पढ़ें ?',
                                    englishText:
                                        'why to study more if everything is in luck?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/x7reF7YHN6Q',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/v6IlDV3cGgY',
                                    urduText: 'پیش گوئی - انگریزی میں لیکچر',
                                    hindiText:
                                        'पेंशन गोई - अंग्रेजी में लेक्चर',
                                    englishText: 'predetermination',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/-QqJIm_8hC0',
                                    urduText:
                                        'بہت سے کام کرنے ہیں لیکن ہم کرنا نہیں چاہتے ہیں',
                                    hindiText:
                                        'इतने सारे काम करने के लिए लेकिन हम नहीं करना चाहते हैं',
                                    englishText:
                                        "So many things to do but we don't want to do",
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/_PDKwmGtCbQ',
                                    urduText:
                                        'بوڑھاپے کے لئے پیسے جما کرنا کیسا ہے ؟',
                                    hindiText:
                                        'बुढ़ापे के लिए पैसे बचाना कैसा है?',
                                    englishText:
                                        'How about savings money for old age?',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/og3ygPic6zg',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                ...
                children: [
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/GEJwQXNijJE',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/IjhOT7HMvmU',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/3DAPlUrRhA0',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/pLvJlJ-f37A',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Hi2LOpM8mW4',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/e8LYc6CJMt8',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/LZvaV5UpPfM',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/q39bIe8NCpg',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/QbGkdi8aJRY',
                                    urduText:
                                        'شادی سے پہلے جسمانی طور پر فٹ ہوجائیں',
                                    hindiText:
                                        'शादी से पहले शारीरिक रूप से फिट',
                                    englishText:
                                        'physically fit before marriage',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/rH2dMDX1mQo',
                                    urduText: 'اسلام میں جنسی تعلیم',
                                    hindiText:
                                        'इस्लाम में सेक्स एजुकेशन (मालूमात )',
                                    englishText: 'Sex Education in Islam',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/8ntpmvwu18A',
                                    urduText: 'دولہا مہندی اور پھول پہنے ہوئے',
                                    hindiText: 'मेहंदी और फूल पहनना दूल्हा',
                                    englishText:
                                        'Groom wearing Mehndi and Flowers',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/M4m8r-Z3l4k',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/M4m8r-Z3l4k',
                                    urduText:
                                        ',لڑکا لڑکی کی اجازت اور ایک دوسرے کو دیکھنا',
                                    hindiText:
                                        'लड़का लड़की की इजाज़त और एक बार दूसरे को देखना',
                                    englishText:
                                        'Boy/girl permission and seeing eachother',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/O6pMblvDhjk',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Ge8i-CFIU10',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/-F-iQIJS-GA',
                                    urduText: '',
                                    hindiText: '',
                                    englishText: '',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/zhY57pM1FQY',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/9glfuJzc-Yc',
                                    urduText:
                                        'کیا منگنی کے بعد فون پر بات کرنا ٹھیک ہے؟',
                                    hindiText:
                                        'क्या मंगनी के बाद फोन पर बात करना ठीक है?',
                                    englishText:
                                        'Is it okay to talk on phone after engagement?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/J8f_kXt-VXQ',
                                    urduText:
                                        'منگنی کے بعد بات/چیت کرنے کے نقصانات',
                                    hindiText:
                                        'मंगनी के बाद कॉल/चैटिंग करने का नुकसान',
                                    englishText:
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/eVvQQcbfqhU',
                                    urduText:
                                        'شادی کے اخراجات کو کم کرنے کے لئے پانچ نکات',
                                    hindiText:
                                        'शादी के खर्च को कम करने के लिए पांच पॉइंट',
                                    englishText:
                                        'five points to reduce marriage expenses',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/zW9sxFQRIAs',
                                    urduText:
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/THu4PH-Gfr0',
                                    urduText:
                                        'اسلام اور جہیز، حضرت فاطمتہ الزہرا کا جہیز',
                                    hindiText:
                                        'जहेज और इस्लाम। हज़रत फातिमा का जहेज़',
                                    englishText:
                                        'Dowry and Islam, dowry of Hazrat fatima',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/riq5Uo3SAiI',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/5EAibs6ii5w',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/vsMnJEEL1mo',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/VpbE8p6ej9o',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/gL18bOK8Te0',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/QdhBIGPei0s',
                                    urduText:
                                        'کیا ولیمہ کے لئے بی وی سے ہمیستری / سیکس ہے؟',
                                    hindiText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/CwKVHFbrOsQ',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/RPFhTOyXdBE',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/Q_lxRRTTEl4',
                                    urduText: 'ہمبستری کے ٥٢علمی پوائنٹس',
                                    hindiText:
                                        'हमबिस्तरी/सेक्स के ५२ इल्मी पॉइंट्स',
                                    englishText: '52 Sexual knowledge points',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/SIQ-6qJoQuA',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/7qN53Wzg-jw',
                                    urduText: 'اچھی بیوی',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/g00A_qe4UTQ',
                                    urduText: 'جوائنٹ فیملی سسٹم اور پردہ',
                                    hindiText:
                                        'ज्वाइंट फैमिली सिस्टम में पर्दा',
                                    englishText:
                                        'Join family system and pardah',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/FNUWuesO7c8',
                                    urduText: 'بیوی کو شوہر سے کیا چاہیئے؟',
                                    hindiText: 'बीवी को शोहर से क्या चाहिए?',
                                    englishText:
                                        'What wife wants from husband?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/rCzboxAwjes',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/s6ZnG4PNyMk',
                                    urduText: 'اسلامی اصطلاح میں ساس باہو',
                                    hindiText: 'सास बहु इस्लामिक तारिख में',
                                    englishText:
                                        'Saas Bahu in islamic terminology',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/wlPRU_ZVNBM',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/phvRtfOHCnk',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/YmbuvrrpRu4',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/PQmlZngZiBA',
                                    urduText: 'کامل شوہر۔ محمد',
                                    hindiText: 'द परफेक्ट हसबैंड - मुहम्मद',
                                    englishText:
                                        'The Perfect Husband - Muhammad',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/lzEbQIy3Ceg',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/ppoXWwL938k',
                                    urduText:
                                        'یہ پانچ چیزیں کریں اپنی بیوی کو قابو میں کرنے کے لیے',
                                    hindiText:
                                        'ये पांच चीजें करें अपनी बीवी को कंट्रोल करने के लिए',
                                    englishText:
                                        'Do these 5 things to control your wife',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/_YWDlnqdurM',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/jEsBevnfAag',
                                    urduText:
                                        'اپنی فیملی کو اپنا پیار دیکھائیں',
                                    hindiText:
                                        'अपनी फैमिली को अपना प्यार दिखाएं',
                                    englishText:
                                        'Realize your love to your family',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/W-2F7QtXv_A',
                                    urduText:
                                        'شوہر کی بیوی سے محبت بڑھانے کا فارمولا',
                                    hindiText:
                                        'मियां बीवी के प्यार को बढ़ाने का नुस्खा',
                                    englishText:
                                        'Formula to increase husband wife love',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/N1g9LLXtZ6k',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/B_dP1q7gamo',
                                    urduText: 'میاں بیوی محبت کی چند باتیں',
                                    hindiText:
                                        'मियां बीवी मोहब्बत की चंद बातें',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/5s0qJVemxOM',
                                    urduText:
                                        'جھوٹے شادی عدالت کا مقدمہ کس طرح لڑنا ہے؟',
                                    hindiText:
                                        'झूठा विवाह कोर्ट का मुकदमा कैसे लड़ें?',
                                    englishText:
                                        'how to fight false marriage court case?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/YmhSHLgd-wk',
                                    urduText:
                                        'اگر بیوی جھوٹے عدالت میں مقدمہ دائر کرتی ہے',
                                    hindiText:
                                        'अगर पत्नी झूठे कोर्ट केस दायर करती है',
                                    englishText:
                                        'if wife files false court case',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/_OBS4xMKRgI',
                                    urduText:
                                        'طلاق اور جہیز کے قانون کا غلط استعمال ہوا',
                                    hindiText: 'तलाक और दहेज कानून का दुरुपयोग',
                                    englishText: 'Divorce & Dowry Laws misused',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/xEu-ZlvvIl8',
                                    urduText:
                                        'بیوی نے جہیز کے جھوٹے معاملے میں کھینچنے کی دھمکی دی',
                                    hindiText:
                                        'पत्नी का झूठे दहेज के मामले में खींचने की धमकी',
                                    englishText:
                                        'Wife threatens to pull into false dowry case',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/RfC-2LBIlHA',
                                    urduText:
                                        'طلاق کی دس وجوہات - ایک وکیل کے ذریعہ',
                                    hindiText:
                                        'तलाक के दस कारण - एक वकील द्वारा',
                                    englishText:
                                        'ten reasons for divorce - By an Advocate',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Hurs0tY4dhI',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/JnZUBvBIZ1g',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/p6RSqMl75HU',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/7bBUVumTeY8',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/3fhmFmtuyM8',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/NA0jMgJ-NvY',
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/eI2g3OpbtfE',
                                    urduText: 'وہ کام جو شیطان کو پسند کرتا ہے',
                                    hindiText:
                                        'वह काम जो शैतान को सबसे ज़्यदा पसंद है',
                                    englishText:
                                        'the act which is most lovable to Satan (Shaitan)',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/GxqF7v2_wng',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/AAzdAKFFnFU',
                                    urduText: 'شادی کے بعد برداشت کرنا سیکھو',
                                    hindiText:
                                        'शादी के बाद बर्दाश्त करना सीखें',
                                    englishText:
                                        'Learn how to compromise after marriage',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/AvZFDCwqcsk',
                ...
                children: [
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/rnRpN0zK67M',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/m_ykOaAUsAI',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/FThmp4CB9-o',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/2I3szEHnUUs',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/p0ZW-LpGX2o',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/FkArTpO_5As',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/_HH66kHF5-Q',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/L8N20Jedepw',
                                    urduText:
                                        'عورتوں کے لئے بیان- اسلام میں برتھ ڈے منانا',
                                    hindiText:
                                        'इस्लाम में बिर्थ डे मानना - औरतों के लिए बयान',
                                    englishText:
                                        'Celebrating birth day in islam - Lecture for women',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/jMPsxzopFb0',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/VXam8VG8jT0',
                                    urduText:
                                        'بچوں کو صفائی کے یہ دس باتیں سکھائیں',
                                    hindiText:
                                        'बच्चों को सफाई के यह दस बातें सिखाएं',
                                    englishText: 'Ten points kids hygiene',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/4IP4lry0IYU',
                                    urduText: 'کلمہ سیکھانے کے بعد کیا سیکھایں',
                                    hindiText:
                                        'कलमा सिखाने के बाद क्या सिखाएं?',
                                    englishText: 'What to teach after Kalima?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/UZFh7bP3YHM',
                                    urduText:
                                        'قرآن حفظ کی امر اور اسکول میں کب ڈالیں',
                                    hindiText:
                                        'हिफ़्ज़ के लिए सबसे अच्छी उम्र। स्कूल में कब डालें ?',
                                    englishText:
                                        'Best age for hifz. when to put in school?',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            ...
                            videosList: [
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/LtdJkutzTf0',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/mlPbwd5Xo34',
                                    urduText:
                                        'بچوں کے جھگڑے اور انکی پڑھائی کو لے کر سنجیدہ',
                                    hindiText:
                                        'बच्चों के झडगे और पढ़ाई को के कर संजीदा',
                                    englishText:
                                        'Kids fight and taking their education sereiesly',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Lpw9hgqKNTU',
                                    urduText:
                                        'بچے ماں باپ سے جھوٹ بولنا سیکھتے ہیں',
                                    hindiText:
                                        'बच्चे मां बाप से झूठ बोलना सीखते हैं',
                                    englishText:
                                        'Kids learn saying lie from parent',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/R_WmF-S1jTk',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/JcpEJ8AxS0Y',
                                    urduText:
                                        'آپکے بچوں میں کونفیڈنس /خود اعتمادی پیدا کرنے کے 4 باتیں',
                                    hindiText:
                                        'आपके बच्चे में कॉन्फिडेंट पैदा करने के लिए ४ बातें',
                                    englishText:
                                        '4 points to build confidence in your kid',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/P5e_2qHngDo',
                                    urduText:
                                        'بچوں کے ساتھ مسجد میں کیسے پیش آئیں',
                                    hindiText:
                                        'बच्चों के साथ मस्जिद में कैसे पेश आएं',
                                    englishText:
                                        'How to behave with children in Masjid',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/T-PwH_skGJY',
                                    urduText:
                                        'بچوں میں نماز کی عادت کیسے ڈالیں',
                                    hindiText:
                                        'बच्चों को नमाज़ का आदत कैसे डालें',
                                    englishText:
                                        'How to make your kid pray namaz',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/xUAlkm8EQtA',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/USaghYToq4Q',
                                    urduText:
                                        'باپ بیٹا خوبصورتی سے قرآن پڑھ رہے',
                                    hindiText:
                                        'बाप बेटा खूबसूरती से क़ुरान पढ़ रहे',
                                    englishText:
                                        'Father and son reciting Quran beautifully',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/Xu9UcOXDavg',
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/beyXCWqMkNE',
                                    urduText:
                                        'اسلامی شریعت کے مطابق کونسا کھیل جائز ہے؟',
                                    hindiText:
                                        'इस्लामिक शरीयत के मुताबिक़ कौन सा खेल जाइज़ है?',
                                    englishText:
                                        'Which sports is legal as per islamic shariah?',
                                },
                            ],
                        },
                    },
                    {
                        ...
                        content: {
                            heading:
                                'PARENTING GUIDELINES - 10 TO 20 YEARS OLD',
                            text:
                            ...
                            videosList: [
                                {
                                    url:
                                        'https://youtube.com/embed/6j_BudpvqFo',
                                    urduText:
                                        'دس سال سے زیادہ عمر کے بچوں کے لئے والدین کا طرز',
                                    hindiText:
                                        '10 साल की उम्र से बच्चों के लिए पेरेंटिंग स्टाइल',
                                    englishText:
                                        'Parenting style for kids from 10 years old',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/nba9rzUWY14',
                                    urduText:
                                        'دسویں /برا ویں کے نتائج کے بعد کیا ؟',
                                    hindiText: '10 वीं / 12 वीं के बाद क्या?',
                                    englishText: 'What after 10th/12th result?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/r37isQ2qFvU',
                                    urduText:
                                        'دس سےبیس سال کے بچوں کے چار مسایل',
                                    hindiText:
                                        'दस से बीस साल के बच्चों के चार मसले',
                                    englishText:
                                        'how to deal with 4 problems in teenagers?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/M9TiF_ICyl0',
                                    urduText: 'اپنے بچے کا دوست بنیں',
                                    hindiText:
                                        'अपने खुद के बच्चे के दोस्त बनें',
                                    englishText:
                                        'Become friend of your own child',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/-QqJIm_8hC0',
                                    urduText:
                                        'زندگی کی منصوبہ بندی کب شروع کریں؟',
                                    hindiText:
                                        'अपने ज़िन्दगी की प्लानिंग कब शुरू करें?',
                                    englishText: 'When to start life planning?',
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/55KjRZK-xYg',
                                    urduText:
                                ...
                                {
                                    url:
                                        'https://youtube.com/embed/HYDVOaMoY6Q',
                                ...
                                },
                                {
                                    url:
                                        'https://youtube.com/embed/CwKVHFbrOsQ',
                                    urduText:
                                        'بچہ بالغ/بڑا کب ہوتا ہے ؟اور غسل کیسے کریں؟',
                                    hindiText:
                                        'बच्चा बालिग़/बड़ा कब होता है? और स्नान कैसे करें?',
                                    englishText:
                    ...
                    videosList: [
                        {
                            ...
                            urduText:
                                'لوگوں کے مابین تنازعہ حل کرنے کو ترجیح دیں',
                            hindiText:
                                'लोगों के बीच झाड़गे को सुलझाने को तरजीह दें',
                            englishText:
                                'give priority to solving dispute between people',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            englishText:
                                "Don't do these ten mistakes in sermon.",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            urduText:
                                'علمائے کرام لوگوں کو قرآن کو سمجھنے کے لئے بتائیں',
                            hindiText:
                                'उलेमा को लोगों को कुरान समझने के लिए कहना चाहिए',
                            englishText:
                                'Ulema should tell people to understand Quran',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            urduText:
                                'ذہین اور کمزور بچوں کو مکاتب میں پڑھانے کا انداز',
                            hindiText:
                        ...
                        },
                        {
                            ...
                            englishText:
                                'What used to happen in Masjid Nabawi?',
                        },
                        {
                    ...
                    videosList: [
                        {
                            ...
                            hindiText: '',
                            englishText:
                                'Life and intention of a Muslim doctor',
                        },
                        {
                            ...
                            hindiText: '',
                            englishText:
                                'Free hospital run by Muslim doctors in America',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            hindiText: '',
                            englishText:
                                'Few Doctor patient communication tips',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            urduText:
                                'علمائے کرام کے بعد ، معاشرے کے ذمہ دار کون ہیں؟',
                            hindiText:
                                'उलमा के बाद, उम्मत के जिम्मेदार कौन हैं?',
                            englishText:
                                'After Ulama, who are responsible of community?',
                        },
                    ],
                },
            },
                ...
                content: {
                    ...
                    videosList: [
                        ...
                        },
                        {
                            ...
                            hindiText: '',
                            englishText:
                                'Role of engineering in developing of the country',
                        },
                        {
                            ...
                            hindiText: '',
                            englishText:
                                'A case study for responsibility of an engineer',
                        },
                    ],
                },
            },
                    ...
                    videosList: [
                        {
                            ...
                            englishText:
                                'Contribution of lawyer in justice in society',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            englishText:
                                'Maulana Tariq Jameel lecture in lawyer',
                        },
                    ],
                },
            },
                    ...
                    videosList: [
                        {
                            ...
                            urduText:
                                'غیر مسلم اسلامی تعلیم کی پابندی کرکے کامیاب ہوتے ہوئے',
                            hindiText:
                    ...
                    videosList: [
                        {
                            ...
                            urduText:
                                'کون مسجد کمیٹی / ٹرسٹی کا حصہ بننا چاہئے',
                            hindiText:
                                'मस्जिद कमेटी / ट्रस्टी का मेंबर कौन होना चाहिए',
                            englishText:
                                'Who should be part of Masjid Committee/Trustee',
                        },
                        {
                            url: 'https://youtube.com/embed/n0CA2LebIow',
                            urduText: 'ون مسجد تحریک - مسجد میں کیا ہونا چاہئے',
                            hindiText:
                                'वन मस्जिद तहरीक - मस्जिद में क्या होना चाहिए',
                            englishText:
                                'One Masjid Movement - What should happen in Masjid',
                        },
                        {
                            url: 'https://youtube.com/embed/neRXVnjngoU',
                            urduText:
                                'مسجد میں ٥ وقت نماز کے علاوہ اور کیا ہونا چاہیے',
                            hindiText:
                        ...
                        },
                        {
                            ...
                            hindiText:
                                'मस्जिद इमाम। गुलामों जैसा बर्ताव क्यों?',
                        ...
                        },
                        {
                            ...
                            hindiText:
                                'इमाम और मस्जिद कमिटी - गलतियां और ज़िम्मेदारी',
                            englishText:
                                'Imam & Masjid Committee - Problems & Duties',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            urduText:
                                'مسجد چندا کے بارے میں اسلامی احکام - زبردستی چندہ',
                            hindiText:
                        ...
                        },
                        {
                            ...
                            hindiText:
                                'मस्जिद चन्दा का इस्तमाल कहाँ नहीं किया जा सकता है?',
                    ...
                    videosList: [
                        {
                            ...
                            hindiText:
                                'ऑटोफैगी (खुद को खाना )और रोज़ा रमजान में',
                            englishText:
                    ...
                    videosList: [
                        {
                            ...
                            urduText:
                                'جانور زبح کرنے کا طریقہ، دعا اور ضروری باتیں',
                            hindiText:
                                'जानवर जबाह कैसे करें? कौनसी दुआ पढ़ें? ज़रूरी हिदायत',
                            englishText:
                                "How to slaughter? What's duwa? And best practices.",
                        },
                        {
                            url: 'https://youtube.com/embed/BX1CavhAzME',
                            urduText: 'قربانی کے جانور کے ساتھ کیسے برتاو کریں',
                            hindiText:
                                'क़ुरबानी के जानवर के साथ कैसे बर्ताव करें',
                ...
                content: {
                    ...
                    videosList: [
                        ...
                        },
                        {
                            ...
                            urduText:
                                'الگورتھم کی ایجاد جسے کمپیوٹر میں استمال کیا جاتا ہے',
                            hindiText:
                                'अल्गोरिथ की ईजाद जिसे कंप्यूटर में इस्तेमाल किया जाता है',
                            englishText:
                                'Invention of Algorithm used in computer',
                        },
                        {
                    ...
                    videosList: [
                        {
                            ...
                            urduText:
                                'دنیا کے پہلے انسان آدم علیہ السلام سے پہلے کیا تھا؟',
                            hindiText:
                        ...
                        },
                        {
                            ...
                            urduText:
                                'اسلام، عیسایت اور یہودیت میں 10 مشترکہ باتیں',
                            hindiText:
                                'इस्लाम, ईसाई धर्म और यहूदी धर्म में १० समान्य बातें',
                            englishText:
                ...
                content: {
                    ...
                    videosList: [
                        ...
                        },
                        {
                            ...
                            urduText:
                                'مسجد تعارفی پروگرام - غیر مسلم بھائیوں کے لئے',
                            hindiText:
                                'मस्जिद परिचय प्रोग्राम - गैर मुस्लिम भाइयों के लिए',
                            englishText:
                        ...
                        },
                        {
                            ...
                            urduText:
                                'اسلام کے بارے میں ٹاپ 10 غلط فہمیاں بشمول دہشت گردی',
                            hindiText:
        ...
        children: [
            {
                ...
                content: {
                    heading:
                        'HOW TO APPLY PASSORT / AADHAAR CARD / VOTER ID CARD',
                    text:
                        // tslint:disable-next-line:max-line-length
